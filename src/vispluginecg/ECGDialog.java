...
public class ECGDialog extends JDialog implements DocumentListener {
    ...
    public ECGDialog() {
        super(null, "ECG Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    ECGDialog(ProjectOrganization organization) {
        super(null, "ECG Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
